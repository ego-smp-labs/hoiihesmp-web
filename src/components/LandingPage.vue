...
<template>
  <div class="min-h-screen bg-transparent text-[#e0d7ec] relative bg-grid-pattern pb-16 flex flex-col font-sans">
    ...
    <header class="w-full bg-[#100a16]/60 backdrop-blur-md border-b border-[#4a3b5c]/30 py-4 px-6 sticky top-0 z-50">
      <div class="max-w-7xl mx-auto flex items-center justify-between">
        <div class="flex items-center gap-3">
          ...
          <span class="font-outfit font-black text-lg lg:text-xl tracking-wider bg-gradient-to-r from-[#ff55ff] to-[#55ffff] bg-clip-text text-transparent">
            HỘI HÈ SMP WIKI
          </span>
        </div>
    ...
    <!-- Main Hero Body -->
    <main class="flex-1 max-w-7xl mx-auto px-6 w-full flex flex-col justify-center py-12 lg:py-20">
