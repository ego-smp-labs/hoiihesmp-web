...
export const itemAssetMap: Record<string, ItemAsset> = {
  ...
  chest: { cdnName: "https://minecraft.wiki/images/Chest_JE4_BE2.png", type: "item", displayName: "Rương" },
  ...
  void_core: { cdnName: "heavy_core", type: "item", displayName: "Void Core", glowColor: "rgba(255, 85, 255, 0.5)" },
