...
export const itemAssetMap: Record<string, ItemAsset> = {
  ...
  heavy_core: { cdnName: "https://minecraft.wiki/images/Heavy_Core_JE1_BE1.png", displayName: "Lõi Nặng" },
  ...
  obsidian_chaos: { cdnName: "https://minecraft.wiki/images/Obsidian_JE3_BE2.png", displayName: "Obsidian Chaos", glowColor: "rgba(255, 26, 26, 0.3)" },
  obsidian: { cdnName: "https://minecraft.wiki/images/Obsidian_JE3_BE2.png", displayName: "Hắc Diện Thạch" },
  netherite_block: { cdnName: "https://minecraft.wiki/images/Block_of_Netherite_JE1_BE1.png", displayName: "Khối Netherite" },
  sculk_catalyst: { cdnName: "https://minecraft.wiki/images/Sculk_Catalyst_JE1.png", displayName: "Sculk Catalyst" },
  echo_shard: { cdnName: "echo_shard", type: "item", displayName: "Mảnh Tiếng Vọng" },
  soul_campfire: { cdnName: "https://minecraft.wiki/images/Soul_Campfire_JE1_BE1.gif", displayName: "Lửa Trại Linh Hồn" },
  ...
  magma_block: { cdnName: "https://minecraft.wiki/images/Magma_Block_JE2.gif", displayName: "Khối Magma" },
  ...
  redstone_block: { cdnName: "https://minecraft.wiki/images/Block_of_Redstone_JE2_BE2.png", displayName: "Khối Đá Đỏ" },
  ...
  copper_block: { cdnName: "https://minecraft.wiki/images/Block_of_Copper_JE1_BE1.png", displayName: "Khối Đồng" },
  ...
  diamond_block: { cdnName: "https://minecraft.wiki/images/Block_of_Diamond_JE5_BE3.png", displayName: "Khối Kim Cương" },
  ...
  campfire: { cdnName: "https://minecraft.wiki/images/Campfire_JE2_BE2.gif", displayName: "Lửa Trại" },
...
export const getCdnUrl = (itemId: string): string => {
  ...
  if (asset.cdnName.startsWith("http://") || asset.cdnName.startsWith("https://") || asset.cdnName.startsWith("/")) {
